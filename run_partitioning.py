...
logger_general.info(
    "The cases for the split were obtained:. An example of first 3 is: %s",
    knowledge[:3],
)
...
logger_general.info(
    "Splitting ended succesfully. Wanted traces %s. Unwanted traces %s",
    len(log_wanted),
    len(log_unwanted),
)
