...
def partition_event_log(data):
    ...
    log_0 = pm4py.filter_event_attribute_values(
        log,
    ...
    log_1 = pm4py.filter_event_attribute_values(
        log,
        attribute_key="case:concept:name",
        values=data_cl_1,
        retain=True,
...
log, log_pd = event_log_import(
    data_path="simple_event_log.xes", pandas=True
)  # reads the event log
